...
INSERT INTO "new_bookings" ("address", "client_id", "consent_accepted_at", "consent_policy_version", "created_at", "end_time", "id", "idempotency_key", "notes", "public_token", "scheduled_date", "service_location", "source", "staff_id", "start_time", "status", "total_duration_minutes", "total_price", "updated_at") SELECT "address", "client_id", "consent_accepted_at", "consent_policy_version", "created_at", "end_time", "id", "idempotency_key", "notes", "public_token", "scheduled_date", "service_location", "source", "staff_id", "start_time", "status", "total_duration_minutes", "total_price", "updated_at" FROM "bookings";
DROP TABLE "bookings";
